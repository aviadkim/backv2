...
const RagMultimodalProcessor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/enhanced/process', formData);
  ...
  const checkStatus = async (id) => {
    try {
      const response = await axios.get(`/api/enhanced/status/${id}`);
  ...
  const getResult = async (id) => {
    try {
      const response = await axios.get(`/api/enhanced/result/${id}`);
  ...
  const getVisualizations = async () => {
    ...
    try {
      const response = await axios.get(`/api/enhanced/visualizations/${taskId}`);
